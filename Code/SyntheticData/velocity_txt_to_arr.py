...
file = 'testED.txt'
input = np.loadtxt('../../Data/InitialConditions/' + file)
...
np.savetxt('../../Data/InitialConditions/x_velocity_' + file, x_arr)
np.savetxt('../../Data/InitialConditions/y_velocity_' + file, y_arr)